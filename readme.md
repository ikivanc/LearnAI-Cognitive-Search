...
* **This training is forked from [Learn AI Content](https://github.com/Azure/LearnAI-Cognitive-Search) and modified with a new scenario for Custom List creation scenario, this part is added in this repo.**
